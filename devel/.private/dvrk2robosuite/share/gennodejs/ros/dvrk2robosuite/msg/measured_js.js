...
class measured_js {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type measured_js
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type measured_js
    let len;
    let data = new measured_js(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new measured_js(null);
